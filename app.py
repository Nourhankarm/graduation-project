...
def get_detections():
    try:
        ...
        # Log received data
        print(f"data received: encoded_gender= {data['gender']}, age= {age}, hypertension= {hypertension}, heart_disease={heart_disease}, encoded_smoking_history= {data['smoking_history']}, bmi= {bmi}, HbA1c_level= {HbA1c_level}, blood_glucose_level= {blood_glucose_level}")
